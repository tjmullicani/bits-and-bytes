...
2. (4) HP StorageWorks D3600
    * These drives are used to perform computations in lieu of server memory (known as y-cruncher Swap Mode[^4]) to provide the resources required to calculate Pi (mounted on the DL580 as /drives/1 - /drives/48). I originally used HP StorageWorks D2600 disk shelves, but I didn't realize the SATA backplane was limited to 3Gb/s. I upgraded to the D3600 disk shelf which supports 6Gb/s SATA in June of 2019.
...
Here is a rough timeline of the world record attempt (still ongoing):
  * Feb 12, 2019    - This is the day I first reached out to Alex Yee about his y-cruncher program. I told him I was interested in breaking the world record (at that time it was 22.4 trillion digits set by Peter Trueb[^5]). My initial thoughts were to use a NetApp DS4486, NetApp FAS3220 filer, and Dell R910 to compute the record. At this point I wasn't sure how many digits I was going to calculate, but I knew it was going to be at least 22.4 trillion in order to beat the record.
...
[^4]: <http://www.numberworld.org/y-cruncher/guides/swapmode.html#intro>{:target="_blank"}
[^5]: <http://www.numberworld.org/y-cruncher/news/2016.html#2016_11_15>{:target="_blank"}
[^6]: <https://youtu.be/BwkpNd2ceBk?t=459>{:target="_blank"}
[^7]: <https://easyengine.io/tutorials/linux/increase-open-files-limit/>{:target="_blank"}